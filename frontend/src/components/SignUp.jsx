    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-600 to-purple-700">
      <div className="bg-white p-10 rounded-lg shadow-2xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="displayName" className="block text-gray-700 font-semibold text-sm mb-2">
              Full Name
            </label>
            <input
              id="displayName"
        ...
        <button 
          ...
          disabled={loading}
          className="w-full py-3 bg-white text-gray-800 font-semibold rounded-lg border border-gray-300 hover:bg-gray-50 hover:border-blue-600 hover:shadow-md transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
        >
